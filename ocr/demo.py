...
def get_ocr_model_converter_opt(model_path):
    ...
    parser.add_argument('--saved_model', default=model_path, help="path to saved_model to evaluation")
    """ Data processing """
...
def get_recognitions(image_folder, model, converter, opt):
...
if __name__ == "__main__":
    get_recognitions('demo_image/', '../models/TPS-ResNet-BiLSTM-Attn-case-sensitive.pth')
